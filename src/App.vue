...
let navigationResizeObserver = new ResizeObserver((entries) => (navigationHeight.value = entries[0].borderBoxSize.inlineSize ?? entries[0].borderBoxSize[0].blockSize));
...
provide('navigationHeight', navigationHeight);
</script>

<template>
  <div class="navigation" ref="navigation">
    <a class="navigation__brand" href="javascript:void(0);">
  ...
  <div class="aside" v-if="mobileMode"></div>
</template>
